...
다음 중 하나라도 해당되면 "NO"로 답변하세요:
1. 업종이 맞지 않는 경우
2. 공공기관인 경우 (세무서, 세관, 구청, 시청, 동주민센터, 경찰서, 소방서, 우체국 등)
3. 세무사/회계사 업종인데 업체명에 "세무서"가 포함된 경우 (공공기관)
4. 이사 업종인데 업체명에 "창고", "보관", "스토리지"가 포함된 경우
5. 청소/이사 업종인데 업체명에 "세탁", "세탁소", "빨래방"이 포함된 경우

이 업체가 해당 업종이 맞고 위 조건에 해당하지 않으면 "YES", 아니면 "NO"로만 답변하세요.

예시:
- "스타벅스" + 업종 "변호사" → NO (업종 불일치)
- "김앤장 법률사무소" + 업종 "변호사" → YES (업종 일치)
- "하남시청" + 업종 "회계사" → NO (공공기관)
- "강남세무서" + 업종 "세무사" → NO (세무서는 공공기관)
- "다올창고" + 업종 "이사 전문" → NO (창고는 이사업체 아님)
- "안전보관센터" + 업종 "이사 전문" → NO (보관업체는 이사업체 아님)
- "크린세탁소" + 업종 "청소 전문" → NO (세탁소는 청소업체 아님)
"""
