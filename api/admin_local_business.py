...
"""
                            ...
                            # OpenAI에 검증 요청
                            prompt = f"""
다음 업체가 업종에 맞는지, 주소가 지역과 일치하는지 검증하세요. 조금이라도 의심되면 무조건 "NO"로 답변하세요.
...
1. **주소-지역 일치 검증 (최우선)**
   - 실제 주소에 등록 지역명이 반드시 포함되어야 함
   - 예시:
     * 지역 "하남시" → 주소에 "하남" 포함 필수
     * 지역 "서울 강남구" → 주소에 "강남" 포함 필수
     * 지역 "부산 해운대구" → 주소에 "해운대" 포함 필수
   - 불일치 시 무조건 NO

2. **업종-업체명 일치 검증**
   - 업체명에서 해당 업종을 명확히 유추할 수 있어야 함
   - 다른 업종을 암시하면 즉시 NO
...
### 4. 자동차 정비 업종일 때 제외
- 주유소, GS칼텍스, SK에너지, 현대오일뱅크
- 세차장, 손세차, 자동세차
- 카센터가 아닌 판매점 (대리점, 전시장)
- 렌터카, 렌트카, 리스
- 업체명에 "주유", "세차", "대리점" 포함

### 5. 전문직 업종일 때 제외 (회계사/세무사/법무사/변호사)
- 음식점 (카페, 식당, 치킨, 피자, 레스토랑, 분식, 중국집, 일식)
- 편의점 (CU, GS25, 세븐일레븐, 이마트24, 미니스톱)
- 마트/쇼핑센터 (이마트, 롯데마트, 홈플러스, 코스트코)
- 약국, 병원, 의원
- PC방, 노래방, DVD방
- 학원, 교습소, 스터디카페
- 숙박업 (호텔, 모텔, 펜션, 게스트하우스)
...
**YES 예시 (모두 만족):**
✅ "김앤장 법률사무소" + 업종 "변호사" + 지역 "서울 강남구" + 주소 "서울 강남구 테헤란로..."
✅ "깨끗한집 청소" + 업종 "청소 전문" + 지역 "경기 수원시" + 주소 "경기 수원시 팔달구..."
✅ "현대자동차정비" + 업종 "자동차 정비" + 지역 "부산 해운대구" + 주소 "부산 해운대구..."

**NO 예시 (하나라도 해당):**
❌ 주소 불일치: 지역 "하남시" + 주소 "서울 강남구..." → 지역 불일치
❌ 주소 불일치: 지역 "서울 강남구" + 주소 "경기 하남시..." → 지역 불일치
❌ 공공기관: "강남세무서" + 업종 "세무사" → 공공기관
❌ 공공기관: "하남시청" + 업종 "회계사" → 공공기관
❌ 세탁업: "크린토피아" + 업종 "청소 전문" → 세탁소
❌ 세탁업: "빨래방24시" + 업종 "청소 전문" → 빨래방
❌ 창고업: "다올창고" + 업종 "이사 전문" → 보관업
❌ 음식점: "스타벅스" + 업종 "변호사" → 카페
❌ 편의점: "GS25" + 업종 "휴대폰 대리점" → 편의점
❌ 마트: "이마트" + 업종 "인테리어" → 대형마트
❌ 주유소: "GS칼텍스" + 업종 "자동차 정비" → 주유소
❌ 업종 불명: "ABC 주식회사" + 업종 "변호사" → 업종 불명확
