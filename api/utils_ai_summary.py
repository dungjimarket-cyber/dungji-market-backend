...
이 리뷰들을 바탕으로 업체의 특징과 장점을 소개하는 문장을 작성해주세요.

**요구사항:**
- 한글 기준 최대 30자 (띄어쓰기 포함)
- 리뷰를 소개하는 부드럽고 자연스러운 어감
- 딱딱한 표현보다는 친근하고 읽기 편한 문장
- 과장 금지, 긍정적이고 객관적인 톤
- 업체명을 주어로 사용하지 말 것
- **반드시 자연스럽고 완성된 한국어 문장으로 작성** (어색한 표현이나 단어 나열 금지)
...
요약 (한글 최대 30자, 부드럽고 자연스러운 문장):"""
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "당신은 비즈니스 리뷰를 분석하고 소개하는 전문가입니다. 한글 기준 최대 30자(띄어쓰기 포함) 이내로 리뷰를 소개하는 부드럽고 자연스러운 문장을 작성합니다. 딱딱한 표현이나 어색한 단어 나열은 절대 금지이며, 친근하고 읽기 편한 한국어 문장을 작성해야 합니다."
                },
                {
                    "role": "user",
                    "content": prompt
