...
def update_groupbuy_status(groupbuy):
    ...
    elif groupbuy.status == 'final_selection' and groupbuy.final_selection_end and now > groupbuy.final_selection_end:
        # 최종선택 결과 확인 및 낙찰자 선정
    ...
    # 3. 판매자 확정 대기 -> 완료
    elif groupbuy.status == 'seller_confirmation' and groupbuy.final_selection_end and now > (groupbuy.final_selection_end + timedelta(hours=24)):
