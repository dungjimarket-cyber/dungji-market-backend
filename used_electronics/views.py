...
class UsedElectronicsViewSet(viewsets.ModelViewSet):
    ...
    def complete_transaction(self, request, pk=None):
        ...
        send_used_trade_notification(
            ...
            message=f"{electronics.brand} {electronics.model_name} 거래가 완료되었습니다. 후기를 남겨보세요",
            push_title="거래 완료"
        )
    ...
    def respond_to_offer(self, request, offer_id=None):
        ...
        if action == 'accept':
            ...
            send_used_trade_notification(
                ...
                message=f"{offer.electronics.brand} {offer.electronics.model_name} 가격 제안이 수락되었습니다",
                push_title="가격 제안 수락"
            )
        else:
            return Response(
        ...
        try:
            ...
            if is_buyer:
                ...
                send_used_trade_notification(
                    ...
                    message=f"{electronics.brand} {electronics.model_name} 거래가 취소되었습니다",
                    push_title="거래 취소"
                )
            else:
                # 판매자가 취소 → 구매자에게 알림
